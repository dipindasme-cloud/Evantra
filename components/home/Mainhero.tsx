...
const heroCars: Car[] = [
  {
    id: 1,
    name: " Drive the Extraordinary",
    specs: " A curated collection of the world’s most iconic supercars, engineered for those who demand precision, power, and presence.",
    video: "/Herowallpaper/Herovideo.mp4",
    poster: "/Herowallpaper/Hero(1).png",
    image: "/Herowallpaper/Hero.png",
    href: "/Herowallpaper/Hero",
  },
];
